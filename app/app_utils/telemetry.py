...
def setup_telemetry() -> str | None:
    ...
    if bucket and capture_content != "false":
        ...
        os.environ.setdefault(
            ...
            f"service.namespace=digital-clutter-cleaner,service.version={commit_sha}",
        )
...
def setup_agent_engine_telemetry() -> None:
    ...
    try:
        ...
        import logging
        logging.warning(f"Could not initialize Agent Engine telemetry (running in local/standalone API key mode): {e}")
